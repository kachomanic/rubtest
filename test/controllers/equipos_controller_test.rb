...
class EquiposControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipo" do
    assert_difference('Equipo.count') do
      post equipos_url, params: { equipo: { descripcion: @equipo.descripcion, nomequip: @equipo.nomequip } }
    end
  ...
  test "should update equipo" do
    patch equipo_url(@equipo), params: { equipo: { descripcion: @equipo.descripcion, nomequip: @equipo.nomequip } }
