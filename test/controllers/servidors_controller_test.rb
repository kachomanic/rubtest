...
class ServidorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create servidor" do
    assert_difference('Servidor.count') do
      post servidors_url, params: { servidor: { dirip: @servidor.dirip, noms: @servidor.noms } }
    end
  ...
  test "should update servidor" do
    patch servidor_url(@servidor), params: { servidor: { dirip: @servidor.dirip, noms: @servidor.noms } }
